...
urlpatterns = [
    ...
    path('scores/<str:meaningless>', views.scores), # easier for c&p of html to backup site
    path('scores/<str:meaningless>/<int:begin>/<int:end>', views.scores_limited), # easier for exporting
